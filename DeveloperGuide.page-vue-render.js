...
with(this){return _c('h3',{attrs:{"id":"view-patient-feature"}},[_v("View patient feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#view-patient-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The view patient operation is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommandParser")]),_v(". "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommandParser")]),_v(" parses the user input string\nand creates the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommand")]),_v(" to be executed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(". "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommand")]),_v(" extends "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" and implements the\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command#execute")]),_v(" method.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. Assuming the application has been launched, the user enters "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view i/t1234567j")]),_v(", which is to find\nthe specific patient with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("IcNumber = t1234567j")]),_v(". This invokes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager#execute")]),_v(" to execute the logic of the\ncommand.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager#execute")]),_v(" would first invoke "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser#parseCommand")]),_v(" which splits the\ncommand word "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view")]),_v(" and the argument "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("i/t1234567j")]),_v(". After splitting, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser#parseCommand")]),_v(" would identify\nthat the command is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("View")]),_v(" and instantiate "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommandParser")]),_v(" and call its "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommandParser#parse")]),_v(" to parse the\nargument\naccordingly.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommandParser#parse")]),_v(" would first map the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("IcNumber")]),_v(" prefix to its argument, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("t1234567j")]),_v("\nusing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArgumentMultimap")]),_v(".\nThe "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArgumentMultimap")]),_v(" would then be passed to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("checkIcNumberPrefixPresent")]),_v(" to check that the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("IcNumber")]),_v(" prefix\nis present. If "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("checkIcNumberPrefixPresent")]),_v(" returns "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("false")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ParseException")]),_v(" is thrown.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PatientWithIcNumberPredicate")]),_v(" predicate, which checks if a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Patient")]),_v(" has the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("IcNumber")]),_v(" is created. It is\nthen passed as an argument along with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("IcNumber")]),_v(" to instantiate the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommand")]),_v(", which is then returned by\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommandParser#parse")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 5. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager#execute")]),_v(" now invokes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ViewCommand#execute")]),_v(" which calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model#updateFilteredPatientList")]),_v(" with\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PatientWithIcNumberPredicate")]),_v(" as an argument. It then returns a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" stating the patient\nhas been listed. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PatientWithFieldNotFoundException")]),_v(" is thrown if no patient found.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Aspect: How to display the specified patient:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Utilize current filteredPatientList display to\ndisplay the patient.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: Similar way in displaying of patient(s) may lead to confusion between commands.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Create a new set of JavaFx controls to display that patient differently\nfrom the current filteredPatientList display.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: New display can be customisable for users' needs.\nCons: New display have to be implemented correctly to integrate with\nexisting displays.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("has to log patient records into the system")]),_v(" "),_c('li',[_v("has to assign patients to the relevant departments")]),_v(" "),_c('li',[_v("has to work under time pressure during an emergency")]),_v(" "),_c('li',[_v("faces frequent interruption due to emergencies")]),_v(" "),_c('li',[_v("has an above average typing speed")]),_v(" "),_c('li',[_v("prefers typing over mouse/voice commands")]),_v(" "),_c('li',[_v("is comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": Advanced&Efficient helps Emergency Department (ED) doctors in logging patient reports and\nassigning patients to relevant departments under time pressure during an emergency, using the CLI.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("View the record of a patient")]),_v(" "),_c('td',[_v("Keep track of every patient’s condition and treatment plan")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Assign a patient to a department")]),_v(" "),_c('td',[_v("Keep track of where each patient is receiving further treatment")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Edit the existing record of a patient")]),_v(" "),_c('td',[_v("Keep the patient’s record relevant and up-to-date")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Delete a patient from my list")]),_v(" "),_c('td',[_v("Declutter and only keep the active patients on my list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Add a patient to the list")]),_v(" "),_c('td',[_v("-")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("View the list of patients")]),_v(" "),_c('td',[_v("-")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Undo my latest action")]),_v(" "),_c('td',[_v("Quickly revert a mistake I made")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Tag patients")]),_v(" "),_c('td',[_v("Better organize patients into categories so as to better keep track of them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Assign the priority to the patient with respect to the severity of the case")]),_v(" "),_c('td',[_v("So that I can keep track of the more critical cases")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Find patients from the list that match a given property (e.g. name, IC number, priority)")]),_v(" "),_c('td',[_v("Quickly narrow down the list to view the patients of my interest")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Quickly view the availability status of a doctor")]),_v(" "),_c('td',[_v("Assign them patients")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Message and communicate with other healthcare staff")]),_v(" "),_c('td',[_v("Coordinate patient care effectively")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Sort my list of active patients by priority/severity")]),_v(" "),_c('td',[_v("Provide timely treatment to the patients in critical condition")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Retrieve the patient’s medical history from the national database after logging them in the system")]),_v(" "),_c('td',[_v("Gather more information to make a more informed diagnosis and as such provide effective treatment for the patient")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Customize shortcuts for my most commonly-used commands")]),_v(" "),_c('td',[_v("Make my workflow more efficient and convenient")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Backup the data in my app")]),_v(" "),_c('td',[_v("Ensure that all the patient information is not completely lost in the event that the data file gets corrupted or the computer’s hardware malfunctions")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Login into the system only using hospital credentials")]),_v(" "),_c('td',[_v("Ensure the confidentiality and security of patient information and limit its access to hospital personnel only")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Securely send a patient’s records to the relevant department")]),_v(" "),_c('td',[_v("Ensure that the other department I am handing my patient to is on the same page as to/updated on the current condition of the patient")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Access clinical guidelines and resources within the application")]),_v(" "),_c('td',[_v("Diagnose and treat patients with greater ease")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("View real-time vitals of patients")]),_v(" "),_c('td',[_v("Monitor patient’s condition efficiently")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Receive notifications for critical situations")]),_v(" "),_c('td',[_v("Provide timely intervention and efficiently handle critical patient conditions")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Save a draft of a message I am writing into the local repository")]),_v(" "),_c('td',[_v("Return to work on it after an emergency call")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("Filter a list of doctors according to their department")]),_v(" "),_c('td',[_v("I can easily identify doctors to assign to from a specific department")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("View the list of doctors")]),_v(" "),_c('td',[_v("I know who I can refer my patients for further treatment to")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("ED Doctor")]),_v(" "),_c('td',[_v("View a list of commands")]),_v(" "),_c('td',[_v("Know the commands needed to carry out my action")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Advanced&Efficient")]),_v("application and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ED doctor")]),_v(",\nunless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("ED doctor requests to add a new patient with given details.")])]),_v(" "),_c('li',[_c('p',[_v("Advanced&Efficient adds the patient to the patient list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Advanced&Efficient detects that the given details are invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. Advanced&Efficient shows an error message saying the given details are invalid.")])]),_v(" "),_c('li',[_c('p',[_v("1a2. Advanced&Efficient requests for correct details.")])]),_v(" "),_c('li',[_c('p',[_v("1a3. ED doctor enters the requested details.")]),_v(" "),_c('p',[_v("Steps 1a1-1a3 are repeated until the details are valid.")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. Advanced&Efficient detects that not all required details are given.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. Advanced&Efficient shows an error message saying that not all required details are given.")])]),_v(" "),_c('li',[_c('p',[_v("1b2. Advanced&Efficient requests for all the required details.")])]),_v(" "),_c('li',[_c('p',[_v("1b3. ED doctor enters the required details.")]),_v(" "),_c('p',[_v("Steps 1b1-1b3 are repeated until all the required details are given.")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. Advanced&Efficient detects that the given patient is already on the patient list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. Advanced&Efficient shows an error message saying patient is already added.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("ED doctor requests to delete a patient of the given IC number.")])]),_v(" "),_c('li',[_c('p',[_v("Advanced&Efficient deletes the patient from the list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Advanced&Efficient detects that the given IC number is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. Advanced&Efficient shows an error message saying the given IC number is invalid.")])]),_v(" "),_c('li',[_c('p',[_v("1a2. Advanced&Efficient requests for correct IC number.")])]),_v(" "),_c('li',[_c('p',[_v("1a3. ED doctor enters the IC number.")]),_v(" "),_c('p',[_v("Steps 1a1-1a3 are repeated until the IC number is valid.")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. Advanced&Efficient detects that the specified patient does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. Advanced&Efficient shows message saying patient does not exist.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC03 - View the list of patients")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("ED doctor requests to view the list of all patients.")])]),_v(" "),_c('li',[_c('p',[_v("Advanced&Efficient shows a list of all patients.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. Advanced&Efficient detects that the list is empty.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. Advanced&Efficient shows a message saying that the list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC04 - View a patient record")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("ED doctor requests to view a patient’s record.")])]),_v(" "),_c('li',[_c('p',[_v("Advanced&Efficient shows the patient’s record.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. Advanced&Efficient detects that the specified patient does not exist.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. Advanced&Efficient shows message saying the patient does not exist.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC05 - Edit a patient record")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("ED doctor requests to edit a patient’s record.")])]),_v(" "),_c('li',[_c('p',[_v("Advanced&Efficient edits the patient’s record as the ED doctor specifies.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Advanced&Efficient detects that the specified patient does not exist.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. Advanced&Efficient shows message saying the patient does not exist.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. Advanced&Efficient detects that the given details are invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. Advanced&Efficient shows an error message saying the given details are invalid.")])]),_v(" "),_c('li',[_c('p',[_v("1b2. Advanced&Efficient requests for the correct details.")])]),_v(" "),_c('li',[_c('p',[_v("1b3. ED doctor enters the requested details.")]),_v(" "),_c('p',[_v("Steps 1b1-1b3 are repeated until the details are valid.")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC06 - Assign a patient to a department")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("ED doctor requests to assign a patient to a department.")])]),_v(" "),_c('li',[_c('p',[_v("Advanced&Efficient assigns the patient to the department based on the input.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. Advanced&Efficient detects that the given department is invalid.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. Advanced&Efficient shows an error message saying the given department is invalid.")])]),_v(" "),_c('li',[_c('p',[_v("1a2. Advanced&Efficient requests for the correct department.")])]),_v(" "),_c('li',[_c('p',[_v("1a3. ED doctor enters the department.")]),_v(" "),_c('p',[_v("Steps 1a1-1a3 are repeated until the department is valid.")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("11")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 patients without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A ED doctor with above average typing speed for regular English text should be able to accomplish most of the tasks\nfaster using commands than using the mouse.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Fri, 27 Oct 2023, 0:46:20 GMT+8]")])])])}
}];
